  ...
  return (
    <ul className="menu__list">
      <li className="menu__item">
        ...
        <input className="menu__input menu__input-half" type="text" name="" id="" value="Un super ID" readOnly />
      </li>
      <li className="menu__item">
        ...
        <input className="menu__input menu__input-half" type="text" name="" id="" placeholder="Nouvel email" />
        <input className="menu__input menu__input-half" type="password" name="" id="" placeholder="Votre mot de passe" />
      </li>
      <li className="menu__item">
        ...
        <input className="menu__input menu__input-half" type="text" name="" id="" placeholder="Votre numéro de téléphone" />
      </li>
    </ul>
  );
};
